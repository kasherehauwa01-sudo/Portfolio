...
- [Анализ МОП](https://kvasmix.ru/vr/analizmop/) показывает «Вход в Calltrack», email и PIN. Заголовок вкладки — «Дашборд отдела продаж». Внутренние функции не проверены и не перечислены.
- [Finomir](https://kvasmix.ru/vr/finomir/) требует PIN. Функции описаны по сведениям владельца; распознавание счетов явно обозначено как развивающийся механизм.
